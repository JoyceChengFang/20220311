...
public class MyGame extends JFrame{
    ...
    private class MyPanel extends JPanel {
        ...
        private void createBall(int clickX, int clickY) {
            clickX = clickX - ballW < 0 ? 0 + ballW/2 : clickX;
            clickY = clickY - ballH < 0 ? 0 + ballH/2 : clickY;
            clickX = clickX + ballW > viewW ? viewW - ballW/2 : clickX;
            clickY = clickY + ballH > viewH ? viewH - ballH/2 : clickY;
        ...
        private class BallTask extends TimerTask {
            ...
            public void run() {
                ...
                // ballX = ballX - dx > viewW ? viewW - ballW : ballX;
                // ballY = ballY - dy > viewH ? viewH - ballH : ballY;
                ballX += dx;
                ballY += dy;
            }
        }
